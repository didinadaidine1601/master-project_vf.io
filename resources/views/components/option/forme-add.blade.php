<div class="content-panel" id="formAdd" style="display: none;">
    <div id="unseen">
        ...
        <form class="form-horizontal" method="post" action="{{ route('add-option') }}">
            @csrf
            <div class="col-lg-10 form-group has-dark" style="padding: 10px">
                <label class="col-sm-2 control-label col-lg-4" for="nom">{{ __("Nom de l'option") }}</label>
                <div class="col-lg-8">
                    <input type="text"
                        @error('nom') 
            ...
            <div class="col-lg-10 form-group has-dark" style="padding: 10px">
                <label class="col-sm-2 control-label col-lg-4" for="mention">{{ __('Mention') }}</label>
                <div class="col-lg-8">
